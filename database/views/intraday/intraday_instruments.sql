DROP MATERIALIZED VIEW quicksight.intraday_instruments;
CREATE MATERIALIZED VIEW quicksight.intraday_instruments AS
...
ORDER BY (t.tpl60_usd - t.fees_usd) desc;

CREATE UNIQUE INDEX ON quicksight.intraday_instruments (instrument_id);
